# Evidence Engine: Architecture and Conventions

**Project:** Evidence Engine
**Author:** Laura White
...
Evidence Engine is built on the [PDA Platform](https://github.com/antnewman/pda-platform), an open-source MCP server that exposes government-grade assurance tooling. The assurance contract that underpins this project is documented in [assurance-for-practitioners.md](https://github.com/antnewman/pda-platform/blob/main/docs/assurance-for-practitioners.md). Evidence Engine wraps that engine with forecasting, cascade propagation, and confidence decomposition; the narrative register, the assurance data model, and the gate-review language all come from PDA Platform.
...
### 6.6 What we are deliberately _not_ doing
...
- Git identity: `Laura White <laura27white@gmail.com>`. Set explicitly in every repo clone.
...
_End of document. Update this file whenever a prompt changes a conventions decision._
