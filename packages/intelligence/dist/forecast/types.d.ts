...
export declare const DEFAULT_FORECAST_CONFIG: Required<Pick<ForecastConfig, 'horizonDays' | 'minMeasurementsRequired'>>;
export declare class ForecastInputError extends Error {
