...
import { ECONOMIC_REFS, EXTERNAL_CATEGORY_EXACT, isExternal, mapRow, normaliseLikelihood, normaliseStatus, parseLinkedItems, xlsxRowSchema, } from '../scripts/hpo-mapping';
...
describe('mapRow', () => {
    ...
    it('tags A047 as tier 1 with BOE external_ref', () => {
        const out = mapRow({ ...validRow, ID: 'A047', Category: 'Economic / Interest Rates' }, PROJECT_ID);
        expect(out.source_tier).toBe(1);
    ...
    it('preserves optional fields that arrive as null', () => {
        const out = mapRow({ ...validRow, Owner: null, 'Review Date': null, 'Linked Items': null }, PROJECT_ID);
...
//# sourceMappingURL=hpo-mapping.test.js.map