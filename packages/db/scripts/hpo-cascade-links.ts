...
export const HPO_CASCADE_LINKS: readonly CascadeLinkDef[] = [
  // -----------------------------------------------------------------------
  ...
  // -----------------------------------------------------------------------
  {
    ...
    rationale:
      'Sustained inflation materially weakens the Buyer fiscal envelope, raising the probability of a delayed or restructured funding schedule.',
  },
  {
    source_code: 'A046',
    target_code: 'A028',
    ...
    rationale:
      'Project internal budgets are set in nominal terms; inflation erodes headroom and tightens the adequacy assumption.',
  },
  {
    source_code: 'A046',
    target_code: 'A025',
    ...
    rationale:
      'Higher inflation increases wage expectations; key delivery staff may renegotiate or leave without uplift.',
  },
  {
    source_code: 'A046',
    target_code: 'A007',
    ...
    rationale:
      'Cost pressure on the Buyer lengthens invoice approval cycles beyond the 15-day assumption.',
  },
  {
    source_code: 'A046',
    target_code: 'A008',
    ...
    rationale:
      'Inflation raises fuel and logistics costs, pushing the site access plan toward the edge of budgeted freight.',
  },
  {
    source_code: 'A046',
    target_code: 'A009',
    ...
    rationale:
      'Cloud provider list prices drift with headline inflation; the stable cloud cost assumption degrades slowly.',
  },
  {
    source_code: 'A046',
    target_code: 'A030',
    propagation_weight: 0.4,
    rationale:
      'LLM licensing fees trend with compute input costs; inflation pressure increases the chance of mid-contract list-price changes.',
  },
  {
    source_code: 'A046',
    target_code: 'A043',
  ...
  },
  {
    ...
    rationale:
      'Inflation may trigger Buyer procurement re-examination and extend onboarding timelines.',
  },
  {
    source_code: 'A046',
    target_code: 'A022',
  ...
  // -----------------------------------------------------------------------
  {
    ...
    rationale:
      'Higher borrowing costs tighten Buyer liquidity, increasing the probability of funding timing slippage.',
  },
  {
    source_code: 'A047',
    target_code: 'A028',
    propagation_weight: 0.55,
    rationale:
      'Financing costs on internal working capital reduce the real budget available for the project.',
  },
  {
    source_code: 'A047',
    target_code: 'A022',
    propagation_weight: 0.5,
    rationale:
      'Supplier and subcontractor cashflows tighten when rates rise, raising delivery risk.',
  },
  {
    source_code: 'A047',
    target_code: 'A012',
    propagation_weight: 0.4,
    rationale:
      'Buyer procurement tightens when debt service pressure rises, extending onboarding cycles.',
  },
  ...
  },
  {
    ...
    propagation_weight: 0.35,
    rationale:
      'Material tax policy change surfaces compliance or contractual disputes that would otherwise stay dormant.',
  },
  {
    source_code: 'A048',
    target_code: 'A045',
